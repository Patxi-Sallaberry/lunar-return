...
about a circular chief \cite{cw1960,fehse} gives
...
asserted. Section~\ref{sec:discussion:verif} reports the test: fed an
independent implementation's injection error, the targeting of
Section~\ref{sec:proximity:hold} reproduces that implementation's $\dv$ to
$1.4\%$, whereas the mirrored convention does not.
